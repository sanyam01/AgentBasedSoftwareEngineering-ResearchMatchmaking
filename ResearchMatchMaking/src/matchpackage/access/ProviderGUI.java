...
public class ProviderGUI extends JFrame implements ActionListener {
	...
	private JButton acceptChange;
	private JButton rejectChange;


	private JPanel jPanel1, jPanel2, jPanel3, jPanel4, jPanel5, jPanel6,overallJPanel;

	private String accepted = "Undecided";
	private String acceptedchange = "Undecided";
	...
	public ProviderGUI( matchpackage.Bidding.Provider provider) {
		...
		overallJPanel.setLayout(new GridLayout(6, 1, 1, 1));
		jPanel1.setLayout(new GridLayout(1, 3, 1, 1));
		jPanel2.setLayout(new GridLayout(1, 3, 1, 1));
		jPanel3.setLayout(new GridLayout(1, 3, 1, 1));
		jPanel4.setLayout(new GridLayout(1, 3, 1, 1));
		jPanel5.setLayout(new GridLayout(1, 3, 1, 1));
		jPanel6.setLayout(new GridLayout(1, 3, 1, 1));

		listLabel = new JLabel("List of providers");
		listProviders = new JTextArea(6,30);
		...
		verifiedIcon = new JTextArea("",6,30);
		submitIcon = new JButton("Submit Icon");
		verifiedIconLabel = new JTextArea("",6,30);
...
//		bidText.setText(this.provider.getProviderPrice());
		...
		contractText = new JTextArea("",6,30);
		...
		acceptChange = new JButton("accept");
		rejectChange = new JButton("Reject");
		acceptChange.addActionListener(this);
		rejectChange.addActionListener(this);

		jPanel6.add(change);
		jPanel6.add(acceptChange);
		jPanel6.add(rejectChange);
	...
	public String getChangeAccepted(){
		return this.acceptedchange;
	}
	...
	public void setChangeAccepted(String rew){
		this.acceptedchange = rew;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==acceptChange){
			this.acceptedchange = "Accept";
		...
		if (e.getSource()==rejectChange){
			this.acceptedchange = "Rejected";
